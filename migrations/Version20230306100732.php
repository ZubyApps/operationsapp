 ...
 */
final class Version20230306100732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE departments ADD CONSTRAINT FK_16AEB8D4F41A619E FOREIGN KEY (head_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE departments ADD head VARCHAR(255) NOT NULL, DROP head_id');
    }
}
