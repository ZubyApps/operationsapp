 ...
 */
final class Version20230328191805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE expenses ADD job VARCHAR(255) DEFAULT NULL, DROP job_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        // $this->addSql('ALTER TABLE expenses ADD job_id INT UNSIGNED DEFAULT NULL, DROP job');
